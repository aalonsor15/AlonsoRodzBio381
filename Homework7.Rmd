...
Since I have more than 2 groups, I used the Tukey post hoc test to generate pairwise comparisons between groups. As expected (due to the means I selected), richness pre hurricane is much different than all of the sampling times right after the hurricane, but as time passes, plant richness continues to increase and gets close to pre hurricane values.
